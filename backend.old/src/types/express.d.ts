...
// User Routes
export type LoginRequest = Request<Record<string, never>, unknown, LoginDto>;
export type SignUpRequest = Request<Record<string, never>, unknown, SignUpDto>;
...
// Bot Routes
export type GetBotsRequest = Request<
  Record<string, never>,
  unknown,
  unknown,
  BotQueryDto
...
export type CreateBotRequest = Request<
  Record<string, never>,
  unknown,
  CreateBotDto
>;
